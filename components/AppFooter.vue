    ...
    <div class="max-w-7xl 2xl:max-w-screen-2xl mx-auto px-4 sm:px-6 lg:px-8">
      <div class="grid md:grid-cols-4 gap-12">
        <div class="col-span-2">
          ...
          >
            Democratizando el acceso a la asesoría legal mediante inteligencia
            artificial de vanguardia. Auditorías transparentes para todos.
          </p>
        ...
        <div>
          ...
          <ul class="space-y-4 text-slate-500 dark:text-slate-400 text-sm">
            ...
            <li>
              <NuxtLink to="/faq" class="hover:text-secondary transition-colors"
                >FAQs</NuxtLink
              >
            </li>
            <li>
      ...
      >
        <p
          class="text-slate-400 text-xs text-center md:text-left max-w-2xl leading-relaxed"
        >
          © 2026 Clarify. Clarify es una guía de análisis asistida por IA. No es
          un abogado ni proporciona asesoría legal. Toda la información generada
