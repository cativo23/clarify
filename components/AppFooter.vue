      ...
      <div class="grid md:grid-cols-4 gap-12">
         ...
         <div>
            ...
            <ul class="space-y-4 text-slate-500 dark:text-slate-400 text-sm">
              <li><NuxtLink to="/about" class="hover:text-secondary transition-colors">Sobre Nosotros</NuxtLink></li>
              <li><NuxtLink to="/faq" class="hover:text-secondary transition-colors">FAQs</NuxtLink></li>
         ...
         <div>
            ...
            <ul class="space-y-4 text-slate-500 dark:text-slate-400 text-sm">
              <li><NuxtLink to="/privacy" class="hover:text-secondary transition-colors">Privacidad</NuxtLink></li>
              <li><NuxtLink to="/terms" class="hover:text-secondary transition-colors">Términos de Uso</NuxtLink></li>
              <li><a href="#" class="hover:text-secondary transition-colors">Contacto</a></li>
            </ul>
         </div>
      </div>
      <div class="mt-20 pt-8 border-t border-slate-100 dark:border-slate-900 flex flex-col md:flex-row justify-between items-start gap-6">
         <p class="text-slate-400 text-xs text-center md:text-left max-w-2xl leading-relaxed">
           © 2026 Clarify. Clarify es una herramienta de asistencia basada en IA. No constituye asesoría legal profesional. Nuestra IA no ha sido entrenada específicamente como abogado y los resultados deben ser revisados por un profesional cualificado.
         </p>
