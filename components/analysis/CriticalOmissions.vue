<template>
  ...
  >
    ...
    <div v-show="isExpanded" class="space-y-4 animate-fade-in pl-14">
      ...
      >
        ...
        <div class="space-y-3">
          ...
          >
            ...
            <p
              class="text-sm font-medium text-amber-900 dark:text-amber-300 leading-relaxed"
            >
          ...
          >
            <p
              class="text-[10px] font-black text-risk-medium uppercase tracking-widest mb-1"
            >
          ...
          >
            <div class="flex items-start gap-3">
              ...
              <div class="flex-1">
                ...
                <p
                  class="text-sm font-medium text-slate-700 dark:text-slate-300 italic leading-relaxed border-l-2 border-secondary/30 pl-3"
                >
      ...
      <!-- Empty state -->
      <div v-if="!omisiones.length" class="text-center py-8">
        <CheckCircleIcon
          class="w-12 h-12 text-risk-low mx-auto mb-3 opacity-50"
        />
