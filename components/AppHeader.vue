<template>
  ...
  >
    <div
      class="px-4 py-4 mx-auto max-w-7xl 2xl:max-w-screen-2xl sm:px-6 lg:px-8"
    >
      <div class="flex items-center justify-between">
        ...
        <div class="flex items-center gap-4 sm:gap-6">
          ...
          >
            <svg
              class="w-5 h-5 transition-transform text-secondary group-hover:scale-110"
              fill="currentColor"
              viewBox="0 0 20 20"
            >
              <path
          ...
          <div v-if="user" class="relative">
            ...
            >
              ...
              <svg
                class="w-4 h-4 transition-transform text-primary-600 dark:text-slate-400"
            ...
            >
              <div
                class="px-4 py-3 border-b border-primary-50 dark:border-slate-800"
              >
                <p
                  class="mb-1 text-xs font-medium tracking-wider uppercase text-primary-400 dark:text-slate-500"
                >
                  Usuario
                </p>
                <p
                  class="text-sm font-semibold truncate text-primary-900 dark:text-white"
                >
                  {{ userEmail }}
                </p>
              </div>
              ...
              <div class="p-1">
                ...
                >
                  <div
                    class="flex items-center justify-center w-8 h-8 rounded-lg bg-slate-100 dark:bg-slate-800"
                  >
                    <svg
                      class="w-4 h-4"
                      fill="none"
                ...
                >
                  <div
                    class="flex items-center justify-center w-8 h-8 rounded-lg bg-secondary/10"
                  >
                    <svg
                      class="w-4 h-4"
                      fill="none"
              ...
              <div class="p-1 border-t border-primary-50 dark:border-slate-800">
                ...
                >
                  <div
                    class="flex items-center justify-center w-8 h-8 rounded-lg bg-risk-high/10"
                  >
                    <svg
                      class="w-4 h-4"
                      fill="none"
