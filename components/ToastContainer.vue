      ...
      >
        <div
          ...
          :class="[
            ...
            toast.type === 'success' ? 'bg-risk-low/10 border-risk-low/30 text-risk-low' :
            toast.type === 'error' ? 'bg-risk-high/10 border-risk-high/30 text-risk-high' :
            toast.type === 'warning' ? 'bg-risk-medium/10 border-risk-medium/30 text-risk-medium' :
