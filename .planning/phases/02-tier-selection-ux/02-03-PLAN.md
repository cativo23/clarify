...
<task type="checkpoint:human-verify" gate="blocking">
  <what-built>Real-time analysis status display with Supabase Realtime integration and AnalysisStatusBadge component</what-built>
  <how-to-verify>
  ...
  <resume-signal>Type "approved" if status displays correctly and updates in real-time, or describe any issues with status display or realtime updates</resume-signal>
</task>
