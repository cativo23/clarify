...
const contractFiles = [
  {
    input: "contrato-alto-riesgo.txt",
    output: "contrato-alto-riesgo.pdf",
    title: "CONTRATO DE PRESTACIÓN DE SERVICIOS - ALTO RIESGO",
  },
  {
    input: "contrato-medio-riesgo.txt",
    output: "contrato-medio-riesgo.pdf",
    title: "CONTRATO DE LICENCIA DE SOFTWARE - RIESGO MEDIO",
  },
  {
    input: "contrato-bajo-riesgo.txt",
    output: "contrato-bajo-riesgo.pdf",
    title: "CONTRATO DE SERVICIOS DIGITALES - BAJO RIESGO",
  },
  {
    input: "contrato-sin-riesgo.txt",
    output: "contrato-sin-riesgo.pdf",
    title: "CONTRATO DE SERVICIOS PROFESIONALES - SIN RIESGO",
  },
];
...
function generatePDF(contract) {
  return new Promise((resolve, reject) => {
    ...
    doc
      ...
      .font("Helvetica")
      .text(
        "Documento de prueba para sistema de análisis de contratos Clarify",
        { align: "center" },
      )
      .moveDown(3)
      .fontSize(10)
      .text(
        "Este documento es un ejemplo de contrato generado para propósitos de testing.",
        { align: "center" },
      )
      .text(
        "Contiene cláusulas diseñadas para evaluar el sistema de categorización de riesgos.",
        { align: "center" },
      )
      .moveDown(2)
      .text(
        `Nivel de riesgo: ${contract.input.includes("alto") ? "ALTO" : contract.input.includes("medio") ? "MEDIO" : contract.input.includes("bajo") ? "BAJO" : "NINGUNO"}`,
        { align: "center" },
      )
      .moveDown(4);
        ...
        if (item.type === "subsection") {
          ...
          for (let rowIndex = 0; rowIndex < totalRows; rowIndex++) {
            ...
            if (isHeader) {
              ...
              doc
                .rect(doc.page.margins.left, cellY, pageWidth, rowHeight)
                .fill();
            }
