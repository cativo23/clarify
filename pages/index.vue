    ...
    <section class="relative overflow-hidden pt-20 pb-24 lg:pt-32 lg:pb-40">
      ...
      <div class="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="text-center">
          ...
          <p class="text-xl lg:text-2xl text-slate-600 dark:text-slate-400 mb-12 max-w-3xl mx-auto leading-relaxed animate-slide-up"
            style="animation-delay: 0.1s">
            Clarify traduce los términos legales complejos en un análisis visual intuitivo.
            <span class="text-slate-900 dark:text-slate-200 font-medium">Audita tus contratos en segundos con IA.</span>
          </p>

          <!-- CTA Buttons -->
          <div class="flex flex-col sm:flex-row gap-4 justify-center items-center mb-20 animate-slide-up"
            ...
            <div
              ...
              <div class="flex flex-wrap justify-center gap-8 sm:gap-16">
                <div class="flex flex-col items-center group">
                  ...
                  <span
                    class="text-slate-900 dark:text-slate-100 font-bold uppercase tracking-widest text-xs">Seguro</span>
                </div>
                <div class="flex flex-col items-center group">
                  <div
                  ...
                  <span
                    class="text-slate-900 dark:text-slate-100 font-bold uppercase tracking-widest text-xs">Precaución</span>
                </div>
                <div class="flex flex-col items-center group">
                  <div
                  ...
                  <span
                    class="text-slate-900 dark:text-slate-100 font-bold uppercase tracking-widest text-xs">Crítico</span>
                </div>
              </div>
            </div>
            <!-- Decorative light -->
            ...
            <div
              ...
              <div class="relative z-10">
                ...
                <p class="text-slate-600 dark:text-slate-400 leading-relaxed">
                  Arrastra tu PDF o imagen. Usamos encriptación para proteger tus datos.
                </p>
              </div>
            </div>
          </div>
          ...
          <div class="relative group">
            <div
              ...
              <div class="relative z-10">
                ...
                <p class="text-slate-600 dark:text-slate-400 leading-relaxed">
                  Visualiza el nivel de riesgo y entiende los puntos críticos en términos sencillos. Sin rodeos.
                </p>
              </div>
            </div>
          </div>
            ...
            <div class="space-y-8">
              <div class="flex gap-6">
                ...
                <div>
                  ...
                  <p class="text-slate-500 dark:text-slate-400">Motor de IA especializado en análisis de documentos para
                    una interpretación clara y precisa.</p>
                </div>
              </div>
              <div class="flex gap-6">
                <div
                ...
                <div>
                  ...
                  <p class="text-slate-500 dark:text-slate-400">Tus datos nunca se usan para entrenar modelos. Lo que es
                    tuyo, se queda contigo.</p>
                </div>
              </div>
              <div class="flex gap-6">
                <div
                ...
                <div>
                  ...
                  <p class="text-slate-500 dark:text-slate-400">Paga solo por lo que necesites. Crétidos flexibles que
                    nunca vencen.</p>
                </div>
              </div>
            </div>
