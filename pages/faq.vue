...
const faqs = [
  {
    question: '¿Es Clarify un servicio legal?',
    answer: 'No. Clarify es una herramienta de análisis de documentos asistida por IA. Proporcionamos una guía intuitiva para entender mejor tus contratos, pero no sustituimos la asesoría de un abogado profesional.'
  },
  {
    question: '¿Cómo funciona el sistema de créditos?',
    answer: 'Cada análisis consume créditos. Un análisis rápido consume 1 crédito, mientras que un análisis profundo (Premium) consume 3 créditos. Puedes comprar paquetes de créditos que nunca vencen.'
  },
  {
    question: '¿Es segura mi información?',
    answer: 'Absolutamente. Utilizamos encriptación SSL en tránsito y reposo. Además, eliminamos los metadatos de los archivos y no almacenamos los documentos originales más allá del tiempo necesario para el análisis.'
  },
  {
