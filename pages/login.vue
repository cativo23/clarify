<template>
  <div
    class="min-h-screen bg-white dark:bg-slate-950 flex items-center justify-center px-4 relative overflow-hidden transition-colors duration-500"
  >
    <!-- Background Decor -->
    <div class="absolute top-0 left-0 w-full h-full pointer-events-none">
      <div
        class="absolute -top-1/4 -left-1/4 w-1/2 h-1/2 bg-secondary/5 rounded-full blur-[120px]"
      ></div>
      <div
        class="absolute -bottom-1/4 -right-1/4 w-1/2 h-1/2 bg-accent-indigo/5 rounded-full blur-[120px]"
      ></div>
    </div>
    <div class="max-w-md w-full">
      ...
      <!-- Auth Card -->
      <div
        class="bg-white dark:bg-slate-900 rounded-[2.5rem] shadow-premium p-10 animate-slide-up relative z-10 border border-slate-100 dark:border-slate-800"
      >
        <div class="mb-10 text-center">
          ...
          <p class="text-slate-500 dark:text-slate-400 font-medium">
            {{
              isSignUp
                ? "Comienza a analizar contratos hoy."
                : "Bienvenido de vuelta a Clarify."
            }}
          </p>
        </div>
        ...
        <div
          v-if="errorMessage"
          class="mb-4 p-3 bg-risk-high/10 border border-risk-high rounded-lg"
        >
        ...
        <div
          v-if="successMessage"
          class="mb-4 p-3 bg-risk-low/10 border border-risk-low rounded-lg"
        >
        ...
        <form class="space-y-6" @submit.prevent="handleSubmit">
          <div>
            <label
              for="email"
              class="block text-xs font-black text-slate-400 dark:text-slate-500 uppercase tracking-widest mb-2 ml-1"
            >
              Email
            </label>
            <input
        ...
        <div class="relative my-8">
          ...
          <div
            class="relative flex justify-center text-xs uppercase tracking-widest font-black text-slate-400"
          >
        ...
        <div class="mt-6 text-center">
          <NuxtLink
            to="/"
            class="text-primary-600 hover:text-primary-900 text-sm transition-colors"
          >
            ← Volver al inicio
          </NuxtLink>
        </div>
