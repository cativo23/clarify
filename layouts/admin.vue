<template>
  ...
  >
    <!-- Mobile Header -->
    <div
      class="lg:hidden sticky top-0 z-50 border-b bg-white/80 dark:bg-slate-900/80 border-slate-100 dark:border-slate-800 backdrop-blur-xl"
    >
      <div class="px-4 py-3 flex items-center justify-between">
        ...
        >
          <div
            class="flex items-center justify-center w-7 h-7 rounded-lg bg-secondary"
          >
    ...
    <div class="flex min-h-screen">
      ...
      >
        <div
          class="flex flex-col h-full bg-white dark:bg-slate-900 border-r border-slate-100 dark:border-slate-800"
        >
          <!-- Logo -->
          <div class="p-6 border-b border-slate-100 dark:border-slate-800">
            <NuxtLink to="/dashboard" class="flex items-center gap-3 group">
              <div
                class="flex items-center justify-center w-10 h-10 rounded-xl bg-gradient-to-br from-secondary to-accent-indigo shadow-lg shadow-secondary/20 group-hover:scale-105 transition-transform"
              >
          ...
          <!-- Sidebar Footer -->
          <div
            class="p-6 border-t border-slate-100 dark:border-slate-800 space-y-6"
          >
            ...
            >
              ...
              >
                <div class="flex items-center gap-3">
                  <div class="relative">
                    <div
                      class="w-10 h-10 rounded-xl bg-gradient-to-br from-secondary to-accent-indigo flex items-center justify-center text-white text-sm font-black shadow-lg shadow-secondary/20"
                    >
                      {{ userInitials }}
                    </div>
                    <div
                  ...
                  <div class="flex-1 min-w-0">
                    <p
                      class="text-[9px] font-black text-secondary uppercase tracking-[0.2em] mb-0.5"
                    >
                      Administrator
                    </p>
                    <p
                  ...
                  <svg
                    class="w-4 h-4 text-slate-300 group-hover:text-secondary transition-transform"
              ...
              <div
                v-if="showUserMenu"
                class="absolute bottom-full left-0 w-full mb-3 p-1.5 bg-white dark:bg-slate-900 border border-slate-100 dark:border-slate-800 rounded-2xl shadow-2xl animate-slide-up z-50"
              >
                <div
                  class="px-3 py-2 border-b border-slate-50 dark:border-slate-800/50 mb-1"
                >
                ...
                <button
                  class="w-full flex items-center gap-3 px-3 py-2 text-xs font-bold text-risk-high hover:bg-risk-high/5 rounded-xl transition-colors"
                  @click="handleSignOut"
                >
                  <div
                    class="w-7 h-7 rounded-lg bg-risk-high/10 flex items-center justify-center"
                  >
                    <svg
                      class="w-4 h-4"
                      fill="none"
